 ...
 * THIS CODE IS USED FOR CNRS WATER BRIEFCASE UNIT
...
//                   TURBIDITY OFFSET
//---------------------------------------------------------
  turbidity =  1.0473 * turbidity + 72.376;                     // ---> WC5
...
void lcd_print_LCSS_banner(){
  ...
  lcd.blink();
  lcd.setCursor(2, 0);
  lcd.print("L");delay(250);lcd.print("E");delay(150);lcd.print(" ");delay(250);lcd.print("C");delay(250);lcd.print("L");delay(250);lcd.print("U");delay(250);lcd.print("B");delay(250);
  lcd.setCursor(10, 1);
  lcd.print("S");delay(250);lcd.print("A");delay(250);lcd.print("N");delay(250);lcd.print("D");delay(250);lcd.print("W");delay(250);lcd.print("I");delay(250);lcd.print("C");delay(250);lcd.print("H");
  lcd.setCursor(3, 2);
  lcd.print("S");delay(250);lcd.print("T");delay(250);lcd.print("U");delay(250);lcd.print("D");delay(250);lcd.print("I");delay(250);lcd.print("O");delay(250);
  delay(3000);
  lcd.noBlink();
  }
